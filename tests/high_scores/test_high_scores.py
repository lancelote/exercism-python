...
from src.high_scores.high_scores import latest
from src.high_scores.high_scores import personal_best
from src.high_scores.high_scores import personal_top_three
