...
from src.triangle.triangle import degenerate
from src.triangle.triangle import equilateral
from src.triangle.triangle import isosceles
from src.triangle.triangle import scalene
